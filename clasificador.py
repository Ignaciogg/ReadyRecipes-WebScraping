...
rutaDiccionario = "./ClasificadorCategoria/DiccionarioL.txt"
rutaListaParada = "./ClasificadorCategoria/ListaParada.txt"
...
def categorizar(rutaModelo, texto):
    modelo = cargarModelo(rutaModelo)
